...
; The 1080-sector blob ends at 0x92000; metadata and the stage-2 stack
; stay above it until the kernel installs its own stack.
%define BDINFO     0x92000
%define BDSEG      0x9200
%define BMODS      0x92400
%define BSTRS      0x92480
%define VBEINFO    0x6000
%define MODEINFO   0x6400
%define MAX_MMAP   32
%define BOOT_BLOCKS 1112
...
.map64:
    ...
    mov eax, cr4
    or eax, (1 << 5) | (1 << 9)   ; PAE + OSFXSR: long-mode SSE faults without it
    mov cr4, eax
    mov eax, 0x70000
    mov cr3, eax
    mov ecx, 0xC0000080
...
BITS 32
msg_banner:  db "BigDevBoot 0.6.0 by bigdevboss", 13, 10, 0
...
msg_modsfail: db "s2: mods FAIL", 13, 10, 0
