...
OBJS = src/boot.o src/kernel.o src/gdt.o src/idt.o src/irq.o src/gfx.o src/interrupt.o src/exceptions.o src/timer.o src/paging.o src/pmm.o src/uaccess.o src/task.o src/tss.o src/syscall.o src/syscall_asm.o src/double_fault.o src/elf.o src/scheduler.o src/ipc.o src/proc.o src/serial.o
...
src/uaccess.o: src/uaccess.c
	$(CC) $(CFLAGS) -c src/uaccess.c -o src/uaccess.o
